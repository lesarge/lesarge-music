...
const updateMetaTags = (song: Song) => {
    ...
    const title = `${song.title} by ${song.creator || 'Unknown Artist'} | Lesarge`;
    const description = `Listen to "${song.title}" - ${song.style}. ${song.viewCount || 0} plays, ${song.likeCount || 0} likes. Create your own AI music with Lesarge.`;
...
const resetMetaTags = () => {
    document.title = 'Lesarge Music AI - Local AI Music Generator';
    const defaultDescription = 'Create original music with AI locally. Generate songs in any style with custom lyrics and professional quality using Lesarge.';
    ...
    updateMeta('meta[property="og:title"]', 'Lesarge Music AI - Local AI Music Generator');
    ...
    updateMeta('meta[name="twitter:title"]', 'Lesarge Music AI - Local AI Music Generator');
