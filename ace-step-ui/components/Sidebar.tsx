...
import { Library, Disc, Search, LogIn, LogOut, Sun, Moon, GraduationCap, Newspaper, Clapperboard } from 'lucide-react';
    ...
    <>
      ...
      <div className="px-3 mb-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div
            className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center cursor-pointer shadow-lg hover:scale-105 transition-transform flex-shrink-0"
            onClick={() => onNavigate('create')}
            title={t('aceStepUI')}
          >
            <span className="text-lg font-extrabold text-white leading-none">L</span>
          </div>
          {isOpen && (
            <span className="text-lg font-bold text-zinc-900 dark:text-white whitespace-nowrap">Lesarge</span>
          )}
        </div>
